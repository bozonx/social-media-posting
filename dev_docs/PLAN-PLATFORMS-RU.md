...
Статус на 30 августа 2026 года: ✅ завершены волна 0 (ядро), волна 1 (`discord`) и связанные
изменения волны A в BloggerDog. Остальные волны запланированы и не считаются начатыми только на
основании наличия описания в этом документе.

| Волна | Состав                               | Статус                                 | Обязательная зависимость                  |
| ----- | ------------------------------------ | -------------------------------------- | ----------------------------------------- |
| 0     | ядро и каталог                       | ✅ Завершена                           | —                                         |
| 1     | Discord                              | ✅ Завершена                           | волна A в BloggerDog ✅                   |
| 2     | YouTube → Vimeo → Dailymotion        | Запланирована                          | волна B в BloggerDog, тестовые аккаунты   |
...
### Волна B — OAuth и длительная обработка (до волны 2)
...
бессмысленно — до волны 3 в наборе нет ни одной pull-сети.
